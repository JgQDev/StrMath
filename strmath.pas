...
function CodeLine.GetAnd(const num1, num2: Number): Number;
var
...
function CodeLine.GetOr(const num1, num2: Number): Number;
var
  TBPosMin,TBPosMax:TBitPos;
  bool1,bool2:Boolean;
begin
...
function CodeLine.GetEqual(const num1, num2: Number): Number;
var
  i:Integer;
begin
  Result:=nil;
