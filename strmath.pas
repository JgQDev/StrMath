...
begin
  ...
  //self.Component_SetInt(numIntArr,AMem1+'TArr1');
  //self.Component_isPositiveAd(AMem1+'TArr1',ByteResult);
...
begin
  ...
  self.TPtrCComponent^.Component_MoveV2ToV1(AMem1+'PaceBaseOne',PaceBaseOneIntVarName);
