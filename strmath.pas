...
type
  ...
  private
    ...
    procedure GetGreaterThan_Real(const num1,num2:Real;var numResult:Number);
    procedure GetGreaterThan_Int(const num1,num2:Integer;var numResult:Number);
    procedure GetGreaterThanOrEqualTo_Real(const num1,num2:Real;var numResult:Number);
    procedure GetGreaterThanOrEqualTo_Int(const num1,num2:Integer;var numResult:Number);
    procedure GetLessThan_Real(const num1,num2:Real;var numResult:Number);
    procedure GetLessThan_Int(const num1,num2:Integer;var numResult:Number);
    procedure GetLessThanOrEqualTo_Real(const num1,num2:Real;var numResult:Number);
    procedure GetLessThanOrEqualTo_Int(const num1,num2:Integer;var numResult:Number);
    ...
    procedure DebugPointCoreAtWithIf_Number_Proc(AParamArr:TParamArr;var ATCCodeProperties:PtrCodeProperties);
    procedure DebugPointCoreAtWithIf_Integer_Proc(AParamArr:TParamArr;var ATCCodeProperties:PtrCodeProperties);
    procedure DebugPointCoreAtWithIf_Real_Proc(AParamArr:TParamArr;var ATCCodeProperties:PtrCodeProperties);
    procedure DebugPointCoreAtWithIf_String_Proc(AParamArr:TParamArr;var ATCCodeProperties:PtrCodeProperties);
    ...
    procedure V1GTV2_Real_Proc(AParamArr:TParamArr;var ATCCodeProperties:PtrCodeProperties);
    procedure V1GTV2_Int_Proc(AParamArr:TParamArr;var ATCCodeProperties:PtrCodeProperties);
    procedure V1GTEqV2_Real_Proc(AParamArr:TParamArr;var ATCCodeProperties:PtrCodeProperties);
    procedure V1GTEqV2_Int_Proc(AParamArr:TParamArr;var ATCCodeProperties:PtrCodeProperties);
    procedure V1LTV2_Real_Proc(AParamArr:TParamArr;var ATCCodeProperties:PtrCodeProperties);
    procedure V1LTV2_Int_Proc(AParamArr:TParamArr;var ATCCodeProperties:PtrCodeProperties);
    procedure V1LTEqV2_Real_Proc(AParamArr:TParamArr;var ATCCodeProperties:PtrCodeProperties);
    procedure V1LTEqV2_Int_Proc(AParamArr:TParamArr;var ATCCodeProperties:PtrCodeProperties);
    ...
    procedure ExitCores_Proc(AParamArr:TParamArr;var ATCCodeProperties:PtrCodeProperties);
    procedure RestartCoreAt_Proc(AParamArr:TParamArr;var ATCCodeProperties:PtrCodeProperties);
  public
    constructor Create;
    ...
    procedure Code_GetParamData(const AIndexBaseZero:Integer;var ValueResult:Number);
    procedure Code_GetParamDataInt(const AIndexBaseZero:Integer;var ValueResult:Integer);
    procedure Code_GetParamDataReal(const AIndexBaseZero:Integer;var ValueResult:Real);
    procedure Code_GetParamDataStr(const AIndexBaseZero:Integer;var ValueResult:String);
    function Code_RunFuncData(var APtrCodeProperties:PtrCodeProperties):Boolean;
  end;
  ...
  private
    ...
    TCRestartCore_Signal:Byte;
    TCRestartCore_AtCore:Integer;
  public
  ...
  public
    ...
    procedure Cores_GetPropertyVar_String(const CoreIndexAt:Integer;const VarName:String;var ValueResult:String);
    ...
    function Cores_isExitCalled_Bool:Boolean;
    function Cores_isExitCalled_Byte:Byte;
  ...
  public
    ...
    function Component_DebugPointCoreAtWithIf(const CoreIndex:Integer;const num1VarName:String;const AValue:Number):Integer;
    function Component_DebugPointCoreAtWithIf(const CoreIndex:Integer;const num1VarName:String;const AValue:Integer):Integer;
    function Component_DebugPointCoreAtWithIf(const CoreIndex:Integer;const num1VarName:String;const AValue:Real):Integer;
    function Component_DebugPointCoreAtWithIf(const CoreIndex:Integer;const num1VarName:String;const AValue:String):Integer;
    ...
    function Component_V1GTV2_Real(const VarName1,VarName2,ResultVarName:String):Integer;
    function Component_V1GTV2_Int(const VarName1,VarName2,ResultVarName:String):Integer;
    function Component_V1GTEqV2_Real(const VarName1,VarName2,ResultVarName:String):Integer;
    function Component_V1GTEqV2_Int(const VarName1,VarName2,ResultVarName:String):Integer;
    function Component_V1LTV2_Real(const VarName1,VarName2,ResultVarName:String):Integer;
    function Component_V1LTV2_Int(const VarName1,VarName2,ResultVarName:String):Integer;
    function Component_V1LTEqV2_Real(const VarName1,VarName2,ResultVarName:String):Integer;
    function Component_V1LTEqV2_Int(const VarName1,VarName2,ResultVarName:String):Integer;
    ...
    function Component_ExitCores:Integer;
    function Component_RestartCoreAt(const VarNameInt:String):Integer;
  end;
...
begin
  ...
  SetLength(TArr1,Length(self.TCodeVar)+1);
  for i:=0 to (Length(self.TCodeVar)-1)do TArr1[i]:=CodeVariable.Create(self.TCodeVar[i]);
  TArr1[Length(TArr1)-1]:=CodeVariable.Create;

  for i:=0 to (Length(self.TCodeVar)-1)do self.TCodeVar[i].Free;
  SetLength(self.TCodeVar,0);

  SetLength(self.TCodeVar,Length(TArr1));
  for i:=0 to (Length(TArr1)-1)do self.TCodeVar[i]:=CodeVariable.Create(TArr1[i]);

  self.Vars:=@self.TCodeVar;
  self.Vars_AtLast:=@self.TCodeVar[Length(self.TCodeVar)-1];

  for i:=0 to (Length(TArr1)-1)do TArr1[i].Free;
  SetLength(TArr1,0);
end;
...
begin
  ...
  SetLength(TArr1,Length(self.TCodeVar)-1);
  for i:=0 to (Length(TArr1)-1)do TArr1[i]:=CodeVariable.Create(self.TCodeVar[i]);
...
begin
  ...
  self.TPtrCComponent^.Component_MoveV2ToV1('Length2','Length1');
  self.TPtrCComponent^.Component_SumInteger('Length1','NumOne','Length1');
...
begin
  ...
  self.TPtrCComponent^.Component_MulInteger('numLength','Num8','ResultLengthVarName');
...
begin
  ...
  self.TPtrCComponent^.Component_AllocateMem('Num3',SizeOf(Integer)-1);
  self.TPtrCComponent^.Component_AllocateMem('Num7',(SizeOf(Integer)*2)-1);
  self.TPtrCComponent^.Component_AllocateMem('Num7B',7);
  self.TPtrCComponent^.Component_AllocateMem('NumCal',0);
  self.TPtrCComponent^.Component_AllocateMem('bool1',0);
  self.TPtrCComponent^.Component_AllocateMem('ByteA',0);
...
begin
  CodeBytes:=nil;
  ArrMath.IntToNumber(43,CodeBytes);
...
function CodeComponentBasic.Component_DebugPointCoreAtWithIf(
  const CoreIndex: Integer; const num1VarName: String; const AValue: Number
  ): Integer;
var
  CodeBytes:Number;
begin
  ...
  self.TCProperty^.Property_CodeArray^.Lines_AtLast^.Code_AddParamDataStr(num1VarName);
  self.TCProperty^.Property_CodeArray^.Lines_AtLast^.Code_AddParamData(AValue);
  self.TCProperty^.Property_CodeArray^.Lines_AtLast^.Code_SetFuncData(@self.TCProperty^.Property_CodeArray^.Lines_AtLast^.DebugPointCoreAtWithIf_Number_Proc);
  Result:=self.TCProperty^.Property_CodeArray^.Lines_ArrLength-1;
...
function CodeComponentBasic.Component_DebugPointCoreAtWithIf(
  const CoreIndex: Integer; const num1VarName: String; const AValue: Integer
  ): Integer;
var
  CodeBytes:Number;
begin
  ...
  self.TCProperty^.Property_CodeArray^.Lines_AtLast^.Code_AddParamDataStr(num1VarName);
  self.TCProperty^.Property_CodeArray^.Lines_AtLast^.Code_AddParamDataInt(AValue);
  self.TCProperty^.Property_CodeArray^.Lines_AtLast^.Code_SetFuncData(@self.TCProperty^.Property_CodeArray^.Lines_AtLast^.DebugPointCoreAtWithIf_Integer_Proc);
  Result:=self.TCProperty^.Property_CodeArray^.Lines_ArrLength-1;
...
function CodeComponentBasic.Component_DebugPointCoreAtWithIf(
  const CoreIndex: Integer; const num1VarName: String; const AValue: Real
  ): Integer;
var
  CodeBytes:Number;
begin
  ...
  self.TCProperty^.Property_CodeArray^.Lines_AtLast^.Code_AddParamDataStr(num1VarName);
  self.TCProperty^.Property_CodeArray^.Lines_AtLast^.Code_AddParamDataReal(AValue);
  self.TCProperty^.Property_CodeArray^.Lines_AtLast^.Code_SetFuncData(@self.TCProperty^.Property_CodeArray^.Lines_AtLast^.DebugPointCoreAtWithIf_Real_Proc);
  Result:=self.TCProperty^.Property_CodeArray^.Lines_ArrLength-1;
...
function CodeComponentBasic.Component_DebugPointCoreAtWithIf(
  const CoreIndex: Integer; const num1VarName: String; const AValue: String
  ): Integer;
var
  CodeBytes:Number;
begin
  ...
  self.TCProperty^.Property_CodeArray^.Lines_AtLast^.Code_AddParamDataStr(num1VarName);
  self.TCProperty^.Property_CodeArray^.Lines_AtLast^.Code_AddParamDataStr(AValue);
  self.TCProperty^.Property_CodeArray^.Lines_AtLast^.Code_SetFuncData(@self.TCProperty^.Property_CodeArray^.Lines_AtLast^.DebugPointCoreAtWithIf_String_Proc);
  Result:=self.TCProperty^.Property_CodeArray^.Lines_ArrLength-1;
...
begin
  CodeBytes:=nil;
  ArrMath.IntToNumber(20,CodeBytes);
...
begin
  CodeBytes:=nil;
  ArrMath.IntToNumber(11,CodeBytes);
...
begin
  CodeBytes:=nil;
  ArrMath.IntToNumber(202,CodeBytes);
...
begin
  CodeBytes:=nil;
  ArrMath.IntToNumber(200,CodeBytes);
...
begin
  CodeBytes:=nil;
  ArrMath.IntToNumber(118,CodeBytes);
...
begin
  CodeBytes:=nil;
  ArrMath.IntToNumber(112,CodeBytes);
...
begin
  CodeBytes:=nil;
  ArrMath.IntToNumber(12,CodeBytes);
...
begin
  CodeBytes:=nil;
  ArrMath.IntToNumber(21,CodeBytes);
...
begin
  CodeBytes:=nil;
  ArrMath.IntToNumber(32,CodeBytes);
...
begin
  CodeBytes:=nil;
  ArrMath.IntToNumber(23,CodeBytes);
...
begin
  CodeBytes:=nil;
  ArrMath.IntToNumber(17,CodeBytes);
...
begin
  CodeBytes:=nil;
  ArrMath.IntToNumber(1,CodeBytes);
...
begin
  CodeBytes:=nil;
  ArrMath.IntToNumber(31,CodeBytes);
...
begin
  CodeBytes:=nil;
  ArrMath.IntToNumber(2,CodeBytes);
...
begin
  CodeBytes:=nil;
  ArrMath.IntToNumber(22,CodeBytes);
...
begin
  CodeBytes:=nil;
  ArrMath.IntToNumber(10,CodeBytes);
...
begin
  CodeBytes:=nil;
  ArrMath.IntToNumber(50,CodeBytes);
...
begin
  CodeBytes:=nil;
  ArrMath.IntToNumber(55,CodeBytes);
...
begin
  CodeBytes:=nil;
  ArrMath.IntToNumber(77,CodeBytes);
...
begin
  CodeBytes:=nil;
  ArrMath.IntToNumber(24,CodeBytes);
...
begin
  CodeBytes:=nil;
  ArrMath.IntToNumber(57,CodeBytes);
...
begin
  CodeBytes:=nil;
  ArrMath.IntToNumber(48,CodeBytes);
...
begin
  CodeBytes:=nil;
  ArrMath.IntToNumber(84,CodeBytes);
...
begin
  CodeBytes:=nil;
  ArrMath.IntToNumber(100,CodeBytes);
...
begin
  CodeBytes:=nil;
  ArrMath.IntToNumber(150,CodeBytes);
...
function CodeComponentBasic.Component_V1GTV2_Real(const VarName1, VarName2,
  ResultVarName: String): Integer;
var
  CodeBytes:Number;
begin
  CodeBytes:=nil;
  ArrMath.IntToNumber(177,CodeBytes);
  ...
  self.TCProperty^.Property_CodeArray^.Lines_AtLast^.Code_AddParamDataStr(VarName2);
  self.TCProperty^.Property_CodeArray^.Lines_AtLast^.Code_AddParamDataStr(ResultVarName);
  self.TCProperty^.Property_CodeArray^.Lines_AtLast^.Code_SetFuncData(@self.TCProperty^.Property_CodeArray^.Lines_AtLast^.V1GTV2_Real_Proc);
  Result:=self.TCProperty^.Property_CodeArray^.Lines_ArrLength-1;

  SetLength(CodeBytes,0);
end;

function CodeComponentBasic.Component_V1GTV2_Int(const VarName1, VarName2,
  ResultVarName: String): Integer;
var
  CodeBytes:Number;
begin
  ...
  self.TCProperty^.Property_CodeArray^.Lines_AtLast^.Code_AddParamDataStr(VarName2);
  self.TCProperty^.Property_CodeArray^.Lines_AtLast^.Code_AddParamDataStr(ResultVarName);
  self.TCProperty^.Property_CodeArray^.Lines_AtLast^.Code_SetFuncData(@self.TCProperty^.Property_CodeArray^.Lines_AtLast^.V1GTV2_Int_Proc);
  Result:=self.TCProperty^.Property_CodeArray^.Lines_ArrLength-1;

  SetLength(CodeBytes,0);
end;

function CodeComponentBasic.Component_V1GTEqV2_Real(const VarName1, VarName2,
  ResultVarName: String): Integer;
var
  CodeBytes:Number;
begin
  CodeBytes:=nil;
  ArrMath.IntToNumber(170,CodeBytes);
  ...
  self.TCProperty^.Property_CodeArray^.Lines_AtLast^.Code_AddParamDataStr(VarName2);
  self.TCProperty^.Property_CodeArray^.Lines_AtLast^.Code_AddParamDataStr(ResultVarName);
  self.TCProperty^.Property_CodeArray^.Lines_AtLast^.Code_SetFuncData(@self.TCProperty^.Property_CodeArray^.Lines_AtLast^.V1GTEqV2_Real_Proc);
  Result:=self.TCProperty^.Property_CodeArray^.Lines_ArrLength-1;

  SetLength(CodeBytes,0);
end;

function CodeComponentBasic.Component_V1GTEqV2_Int(const VarName1, VarName2,
  ResultVarName: String): Integer;
var
  CodeBytes:Number;
begin
  ...
  self.TCProperty^.Property_CodeArray^.Lines_AtLast^.Code_AddParamDataStr(VarName2);
  self.TCProperty^.Property_CodeArray^.Lines_AtLast^.Code_AddParamDataStr(ResultVarName);
  self.TCProperty^.Property_CodeArray^.Lines_AtLast^.Code_SetFuncData(@self.TCProperty^.Property_CodeArray^.Lines_AtLast^.V1GTEqV2_Int_Proc);
  Result:=self.TCProperty^.Property_CodeArray^.Lines_ArrLength-1;

  SetLength(CodeBytes,0);
end;

function CodeComponentBasic.Component_V1LTV2_Real(const VarName1, VarName2,
  ResultVarName: String): Integer;
var
  CodeBytes:Number;
begin
  CodeBytes:=nil;
  ArrMath.IntToNumber(111,CodeBytes);
  ...
  self.TCProperty^.Property_CodeArray^.Lines_AtLast^.Code_AddParamDataStr(VarName2);
  self.TCProperty^.Property_CodeArray^.Lines_AtLast^.Code_AddParamDataStr(ResultVarName);
  self.TCProperty^.Property_CodeArray^.Lines_AtLast^.Code_SetFuncData(@self.TCProperty^.Property_CodeArray^.Lines_AtLast^.V1LTV2_Real_Proc);
  Result:=self.TCProperty^.Property_CodeArray^.Lines_ArrLength-1;

  SetLength(CodeBytes,0);
end;

function CodeComponentBasic.Component_V1LTV2_Int(const VarName1, VarName2,
  ResultVarName: String): Integer;
var
  CodeBytes:Number;
begin
  ...
  self.TCProperty^.Property_CodeArray^.Lines_AtLast^.Code_AddParamDataStr(VarName2);
  self.TCProperty^.Property_CodeArray^.Lines_AtLast^.Code_AddParamDataStr(ResultVarName);
  self.TCProperty^.Property_CodeArray^.Lines_AtLast^.Code_SetFuncData(@self.TCProperty^.Property_CodeArray^.Lines_AtLast^.V1LTV2_Int_Proc);
  Result:=self.TCProperty^.Property_CodeArray^.Lines_ArrLength-1;

  SetLength(CodeBytes,0);
end;

function CodeComponentBasic.Component_V1LTEqV2_Real(const VarName1, VarName2,
  ResultVarName: String): Integer;
var
  CodeBytes:Number;
begin
  CodeBytes:=nil;
  ArrMath.IntToNumber(110,CodeBytes);
  ...
  self.TCProperty^.Property_CodeArray^.Lines_AtLast^.Code_AddParamDataStr(VarName2);
  self.TCProperty^.Property_CodeArray^.Lines_AtLast^.Code_AddParamDataStr(ResultVarName);
  self.TCProperty^.Property_CodeArray^.Lines_AtLast^.Code_SetFuncData(@self.TCProperty^.Property_CodeArray^.Lines_AtLast^.V1LTEqV2_Real_Proc);
  Result:=self.TCProperty^.Property_CodeArray^.Lines_ArrLength-1;

  SetLength(CodeBytes,0);
end;

function CodeComponentBasic.Component_V1LTEqV2_Int(const VarName1, VarName2,
  ResultVarName: String): Integer;
var
  CodeBytes:Number;
begin
  ...
  self.TCProperty^.Property_CodeArray^.Lines_AtLast^.Code_AddParamDataStr(VarName2);
  self.TCProperty^.Property_CodeArray^.Lines_AtLast^.Code_AddParamDataStr(ResultVarName);
  self.TCProperty^.Property_CodeArray^.Lines_AtLast^.Code_SetFuncData(@self.TCProperty^.Property_CodeArray^.Lines_AtLast^.V1LTEqV2_Int_Proc);
  Result:=self.TCProperty^.Property_CodeArray^.Lines_ArrLength-1;
...
begin
  CodeBytes:=nil;
  ArrMath.IntToNumber(88,CodeBytes);
...
begin
  CodeBytes:=nil;
  ArrMath.IntToNumber(36,CodeBytes);
...
begin
  CodeBytes:=nil;
  ArrMath.IntToNumber(13,CodeBytes);
...
begin
  CodeBytes:=nil;
  ArrMath.IntToNumber(60,CodeBytes);
...
begin
  CodeBytes:=nil;
  ArrMath.IntToNumber(96,CodeBytes);
...
begin
  CodeBytes:=nil;
  ArrMath.IntToNumber(19,CodeBytes);
...
begin
  CodeBytes:=nil;
  ArrMath.IntToNumber(91,CodeBytes);
...
begin
  CodeBytes:=nil;
  ArrMath.IntToNumber(30,CodeBytes);
...
begin
  CodeBytes:=nil;
  ArrMath.IntToNumber(39,CodeBytes);
...
begin
  CodeBytes:=nil;
  ArrMath.IntToNumber(93,CodeBytes);
...
begin
  CodeBytes:=nil;
  ArrMath.IntToNumber(80,CodeBytes);
  ...
  if(self.isVarNameValid(PortName)=False)then begin
    SetLength(CodeBytes,0);
    Exit;
  end;
...
begin
  CodeBytes:=nil;
  ArrMath.IntToNumber(188,CodeBytes);
...
begin
  CodeBytes:=nil;
  ArrMath.IntToNumber(40,CodeBytes);
...
begin
  CodeBytes:=nil;
  ArrMath.IntToNumber(65,CodeBytes);
...
begin
  CodeBytes:=nil;
  ArrMath.IntToNumber(92,CodeBytes);
...
begin
  CodeBytes:=nil;
  ArrMath.IntToNumber(94,CodeBytes);
...
function CodeComponentBasic.Component_ExitCores: Integer;
var
  CodeBytes:Number;
begin
  CodeBytes:=nil;
  ArrMath.IntToNumber(73,CodeBytes);

  self.TCProperty^.Property_CodeArray^.Lines_CreateLast;
  self.TCProperty^.Property_CodeArray^.Lines_AtLast^.Code_SetCodeData(CodeBytes);
  self.TCProperty^.Property_CodeArray^.Lines_AtLast^.Code_SetFuncData(@self.TCProperty^.Property_CodeArray^.Lines_AtLast^.ExitCores_Proc);
  Result:=self.TCProperty^.Property_CodeArray^.Lines_ArrLength-1;

  SetLength(CodeBytes,0);
end;

function CodeComponentBasic.Component_RestartCoreAt(const VarNameInt: String
  ): Integer;
var
  CodeBytes:Number;
begin
  CodeBytes:=nil;
  ArrMath.IntToNumber(72,CodeBytes);

  self.TCProperty^.Property_CodeArray^.Lines_CreateLast;
  self.TCProperty^.Property_CodeArray^.Lines_AtLast^.Code_SetCodeData(CodeBytes);
  self.TCProperty^.Property_CodeArray^.Lines_AtLast^.Code_AddParamDataStr(VarNameInt);
  self.TCProperty^.Property_CodeArray^.Lines_AtLast^.Code_SetFuncData(@self.TCProperty^.Property_CodeArray^.Lines_AtLast^.RestartCoreAt_Proc);
  Result:=self.TCProperty^.Property_CodeArray^.Lines_ArrLength-1;
...
begin
  self.TCPropertyArr[self.TCoreIndex].TCMemCapNum:=self.TCoreIndex;
end;
...
procedure CodeCores.Cores_GetPropertyVar_Number(const CoreIndexAt: Integer;
  const VarName: String; var ValueResult: Number);
begin
  SetLength(ValueResult,0);
  if(CoreIndexAt<0)or(CoreIndexAt>(self.Cores_ArrLength-1))then Exit;
  self.TCPropertyArr[CoreIndexAt].Property_CodeVariable^.Vars_AtLast^.Var_GetValue(VarName,ValueResult);
end;

procedure CodeCores.Cores_GetPropertyVar_Integer(const CoreIndexAt: Integer;
  const VarName: String; var ValueResult: Integer);
begin
  ValueResult:=0;
  if(CoreIndexAt<0)or(CoreIndexAt>(self.Cores_ArrLength-1))then Exit;
  self.TCPropertyArr[CoreIndexAt].Property_CodeVariable^.Vars_AtLast^.Var_GetValueInt(VarName,ValueResult);
end;

procedure CodeCores.Cores_GetPropertyVar_Real(const CoreIndexAt: Integer;
  const VarName: String; var ValueResult: Real);
begin
  ValueResult:=0.0;
  if(CoreIndexAt<0)or(CoreIndexAt>(self.Cores_ArrLength-1))then Exit;
  self.TCPropertyArr[CoreIndexAt].Property_CodeVariable^.Vars_AtLast^.Var_GetValueReal(VarName,ValueResult);
end;

procedure CodeCores.Cores_GetPropertyVar_String(const CoreIndexAt: Integer;
  const VarName: String; var ValueResult: String);
begin
  ValueResult:='';
  if(CoreIndexAt<0)or(CoreIndexAt>(self.Cores_ArrLength-1))then Exit;
  self.TCPropertyArr[CoreIndexAt].Property_CodeVariable^.Vars_AtLast^.Var_GetValueStr(VarName,ValueResult);
end;
...
begin
  ...
  (self.TCPropertyIndexDoneArr[self.TCoreIndex]<2)then begin
    APtrCProperty:=@self.TCPropertyArr[self.TCoreIndex];
    Result:=self.TCPropertyArr[self.TCoreIndex].Property_CodeArray^.Lines^[AIndex].Code_RunFuncData(APtrCProperty);
  ...
  if(self.TCPropertyArr[self.TCoreIndex].TCRestartCore_Signal>0)then begin
    AIndex:=self.TCPropertyArr[self.TCoreIndex].TCRestartCore_AtCore;
    if(AIndex<0)or(AIndex>(self.Cores_ArrLength-1))then begin
      self.TCLogs.Warning_CreateLastLog('Warning: RestartCore value out of bound, will pass'+' | At-Core: '+IntToStr(self.TCoreIndex));
    end else begin
      self.TCPropertyArr[AIndex].Property_ResetAll;
      self.TCPropertyIndexDoneArr[AIndex]:=0;
      self.TCPropertyOutBoundBoolArr[AIndex]:=False;
      self.TCPropertyDoneBoolArr[AIndex]:=False;
    end;
    self.TCPropertyArr[self.TCoreIndex].TCRestartCore_Signal:=0;
    self.TCPropertyArr[self.TCoreIndex].TCRestartCore_AtCore:=-1;
  end;
...
begin
  ...
  While(True)do begin
    if(self.Cores_GetCoreIndexAt<=0)then begin
      if(nCount1>=self.Cores_ArrLength)then break;
      nCount1:=0;
    end;
    ...
    if(self.Cores_isExitCalled_Bool=True)then break;
    if(self.Cores_isPropertyOutBound=True)then nCount1:=nCount1+1;
    self.Cores_Continue;
  end;
  Result:=True;
end;
...
begin
  ...
  While(True)do begin
    ...
    if(self.Cores_isExitCalled_Bool=True)then break;
    if(self.Cores_isPropertyDone=True)then nCount1:=nCount1+1;
    self.Cores_Continue;
  end;
  Result:=True;
end;

function CodeCores.Cores_isExitCalled_Bool: Boolean;
begin
  Result:=False;
  if(self.TCoreIndex<0)or(self.TCoreIndex>(self.Cores_ArrLength-1))then Exit;
  if(self.TCPropertyArr[self.TCoreIndex].TCExitCores>0)then Result:=True;
end;

function CodeCores.Cores_isExitCalled_Byte: Byte;
begin
  Result:=0;
  if(self.TCoreIndex<0)or(self.TCoreIndex>(self.Cores_ArrLength-1))then Exit;
  Result:=self.TCPropertyArr[self.TCoreIndex].TCExitCores;
end;
...
begin
  ...
  AIndex:=-1;
  if(self.isVarNameExist(AVarName,AIndex)=True)and(AIndex>-1)then
    ArrMath.NumberToInt(self.TVarArr[AIndex],ValueResult);
end;
...
begin
  ...
  AIndex:=-1;
  if(self.isVarNameExist(AVarName,AIndex)=True)and(AIndex>-1)then
    ArrMath.NumberToReal(self.TVarArr[AIndex],ValueResult);
end;
...
begin
  ...
  AIndex:=-1;
  if(self.isVarNameExist(AVarName,AIndex)=True)and(AIndex>-1)then
    ArrMath.NumberToStr(self.TVarArr[AIndex],ValueResult);
end;
...
begin
  ...
  self.TCRestartCore_Signal:=0;
  self.TCRestartCore_AtCore:=-1;
...
begin
  ...
  self.TCExitCores:=ACodeProperties.TCExitCores;

  self.TCRestartCore_Signal:=ACodeProperties.TCRestartCore_Signal;
  self.TCRestartCore_AtCore:=ACodeProperties.TCRestartCore_AtCore;
...
procedure CodeLine.GetGreaterThan_Real(const num1, num2: Real;
...
procedure CodeLine.GetGreaterThan_Int(const num1, num2: Integer;
  var numResult: Number);
begin
  SetLength(numResult,0);
  SetLength(numResult,Length(numResult)+1);
...
procedure CodeLine.GetGreaterThanOrEqualTo_Real(const num1, num2: Real;
  var numResult: Number);
begin
  SetLength(numResult,0);
  SetLength(numResult,Length(numResult)+1);
...
procedure CodeLine.GetGreaterThanOrEqualTo_Int(const num1, num2: Integer;
  var numResult: Number);
begin
  SetLength(numResult,0);
  SetLength(numResult,Length(numResult)+1);
...
procedure CodeLine.GetLessThan_Real(const num1, num2: Real;
  var numResult: Number);
begin
  SetLength(numResult,0);
  SetLength(numResult,Length(numResult)+1);
...
procedure CodeLine.GetLessThan_Int(const num1, num2: Integer;
  var numResult: Number);
begin
  SetLength(numResult,0);
  SetLength(numResult,Length(numResult)+1);
...
procedure CodeLine.GetLessThanOrEqualTo_Real(const num1, num2: Real;
  var numResult: Number);
begin
  SetLength(numResult,0);
  SetLength(numResult,Length(numResult)+1);
...
procedure CodeLine.GetLessThanOrEqualTo_Int(const num1, num2: Integer;
  var numResult: Number);
begin
  SetLength(numResult,0);
  SetLength(numResult,Length(numResult)+1);
...
begin
  ...
  ArrMath.NumberToInt(AParamArr[0],numValue);
  num1:=0;
...
begin
  ...
  ATCCodeProperties^.Property_CodeVariable^.Vars_AtLast^.Var_GetValue(num1AIndex,num1V);
...
begin
  ...
  ArrMath.NumberToStr(AParamArr[0],num1Str);
  ArrMath.NumberToInt(AParamArr[1],numValue);
  ...
  ATCCodeProperties^.Property_CodeVariable^.Vars_AtLast^.Var_GetValueInt(num1AIndex,num1V);
...
begin
  ...
  ArrMath.NumberToStr(AParamArr[0],num1Str);
  ArrMath.NumberToReal(AParamArr[1],numValue);
  ...
  ATCCodeProperties^.Property_CodeVariable^.Vars_AtLast^.Var_GetValueReal(num1AIndex,num1V);
...
begin
  ...
  ArrMath.NumberToStr(AParamArr[0],num1Str);
  ArrMath.NumberToStr(AParamArr[1],numValue);
  ...
  ATCCodeProperties^.Property_CodeVariable^.Vars_AtLast^.Var_GetValueStr(num1AIndex,num1V);
...
procedure CodeLine.DebugPointCoreAtWithIf_Number_Proc(AParamArr: TParamArr;
  var ATCCodeProperties: PtrCodeProperties);
var
  num1Str:String;
  num1AIndex:Integer;
...
begin
  ...
  ArrMath.NumberToInt(AParamArr[0],numCoreAt);
  ArrMath.NumberToStr(AParamArr[1],num1Str);
  ArrMath.NumberToNumber(AParamArr[2],numValue);
  ...
  num1:=0;
  self.GetEqual(num1V,numValue,IfNum);
  if(IfNum[0]=1)and(ATCCodeProperties^.TCMemCapNum=numCoreAt)then begin
    num1:=num1+1;
    num1:=num1+1;
    num1:=num1+1;
  end;
...
procedure CodeLine.DebugPointCoreAtWithIf_Integer_Proc(AParamArr: TParamArr;
  var ATCCodeProperties: PtrCodeProperties);
var
  num1Str:String;
  num1AIndex:Integer;
...
begin
  ...
  ArrMath.NumberToInt(AParamArr[0],numCoreAt);
  ArrMath.NumberToStr(AParamArr[1],num1Str);
  ArrMath.NumberToInt(AParamArr[2],numValue);
  ...
  num1:=0;
  if(num1V=numValue)and(ATCCodeProperties^.TCMemCapNum=numCoreAt)then begin
    num1:=num1+1;
    num1:=num1+1;
    num1:=num1+1;
  end;
...
procedure CodeLine.DebugPointCoreAtWithIf_Real_Proc(AParamArr: TParamArr;
  var ATCCodeProperties: PtrCodeProperties);
var
  num1Str:String;
  num1AIndex:Integer;
...
begin
  ...
  ArrMath.NumberToInt(AParamArr[0],numCoreAt);
  ArrMath.NumberToStr(AParamArr[1],num1Str);
  ArrMath.NumberToReal(AParamArr[2],numValue);
...
procedure CodeLine.DebugPointCoreAtWithIf_String_Proc(AParamArr: TParamArr;
  var ATCCodeProperties: PtrCodeProperties);
var
  num1Str:String;
  num1AIndex:Integer;
...
begin
  ...
  ArrMath.NumberToInt(AParamArr[0],numCoreAt);
  ArrMath.NumberToStr(AParamArr[1],num1Str);
  ArrMath.NumberToStr(AParamArr[2],numValue);
...
begin
  ...
  ArrMath.NumberToStr(AParamArr[0],num1Str);
  ArrMath.NumberToStr(AParamArr[1],num2Str);
  ArrMath.NumberToStr(AParamArr[2],ResultStr);
  ...
  ATCCodeProperties^.Property_CodeVariable^.Vars_AtLast^.Var_GetValueInt(num1AIndex,num1V);
  ATCCodeProperties^.Property_CodeVariable^.Vars_AtLast^.Var_GetValueInt(num2AIndex,num2V);
...
begin
  ...
  ArrMath.NumberToStr(AParamArr[1],num2Str);
  ArrMath.NumberToStr(AParamArr[2],ResultStr);
  ArrMath.NumberToStr(AParamArr[3],isMulStr);
  ...
  ATCCodeProperties^.Property_CodeVariable^.Vars_AtLast^.Var_GetValueInt(num1AIndex,num1V);
  ATCCodeProperties^.Property_CodeVariable^.Vars_AtLast^.Var_GetValueInt(num2AIndex,num2V);
  ATCCodeProperties^.Property_CodeVariable^.Vars_AtLast^.Var_GetValueInt(isMulAIndex,isMulV);
...
begin
  ...
  ATCCodeProperties^.Property_CodeVariable^.Vars_AtLast^.Var_GetValueReal(num1AIndex,AReal1);
  ATCCodeProperties^.Property_CodeVariable^.Vars_AtLast^.Var_GetValueReal(num2AIndex,AReal2);
...
begin
  ...
  ArrMath.NumberToStr(AParamArr[0],ArrayStr);
  ArrMath.NumberToStr(AParamArr[1],IndexStr);
  ArrMath.NumberToStr(AParamArr[2],ResultVarStr);
  ...
  ATCCodeProperties^.Property_CodeVariable^.Vars_AtLast^.Var_GetValue(ArrayAIndex,Anum1);
  ATCCodeProperties^.Property_CodeVariable^.Vars_AtLast^.Var_GetValueInt(IndexAIndex,Anum2);

  if(Anum2<0)or(Anum2>(Length(Anum1)-1))then begin
    ATCCodeProperties^.TCLogs^.Error_CreateLastLog('Error: ArrayIndexGet() Index "'+IndexStr+'" is out of bound in Byte Array "'+ArrayStr+'"');
    ATCCodeProperties^.TCLogs^.Error_CreateLastLog('Error: Var "'+IndexStr+'" value is '+IntToStr(Anum2));
    ATCCodeProperties^.TCLogs^.Error_CreateLastLog('Error: Var "'+ArrayStr+'" Length-Base-Zero is '+IntToStr(Length(Anum1)-1));
    SetLength(Anum1,0);
    SetLength(Anum3,0);
    Exit;
  end;
...
begin
  ...
  ArrMath.NumberToStr(AParamArr[0],ArrayStr);
  ArrMath.NumberToStr(AParamArr[1],IndexStr);
  ArrMath.NumberToStr(AParamArr[2],ValueVarStr);
  ...
  ATCCodeProperties^.Property_CodeVariable^.Vars_AtLast^.Var_GetValueInt(IndexAIndex,Anum2);
  ATCCodeProperties^.Property_CodeVariable^.Vars_AtLast^.Var_GetValue(ValueVarAIndex,Anum3);

  if(Anum2<0)or(Anum2>(Length(Anum1^)-1))then begin
    ATCCodeProperties^.TCLogs^.Error_CreateLastLog('Error: ArrayIndexSet() Index "'+IndexStr+'" is out of bound in Byte Array "'+ArrayStr+'"');
    ATCCodeProperties^.TCLogs^.Error_CreateLastLog('Error: Var "'+IndexStr+'" value is '+IntToStr(Anum2));
    ATCCodeProperties^.TCLogs^.Error_CreateLastLog('Error: Var "'+ArrayStr+'" Length-Base-Zero is '+IntToStr(Length(Anum1^)-1));
    Anum1:=nil;
    SetLength(Anum3,0);
  ...
  if(Length(Anum3)>0)then begin
    Anum1^[Anum2]:=Anum3[0];
  end else begin
    ATCCodeProperties^.TCLogs^.Warning_CreateLastLog('Warning: Var "'+ValueVarStr+'" is nil, will pass');
  end;
...
begin
  ...
  ArrMath.NumberToStr(AParamArr[0],StrStr);
  ArrMath.NumberToStr(AParamArr[1],IndexStr);
  ArrMath.NumberToStr(AParamArr[2],ResultVarStr);
  ...
  ATCCodeProperties^.Property_CodeVariable^.Vars_AtLast^.Var_GetValueStr(StrAIndex,Anum1);
  ATCCodeProperties^.Property_CodeVariable^.Vars_AtLast^.Var_GetValueInt(IndexAIndex,Anum2);
...
begin
  ...
  ArrMath.NumberToStr(AParamArr[0],ArrayVarStr);
  ArrMath.NumberToStr(AParamArr[1],ArrayLengthVarStr);
  ...
  ATCCodeProperties^.Property_CodeVariable^.Vars_AtLast^.Var_GetValueInt(ArrayLengthVarAIndex,ArrayLengthVarV);
...
begin
  ...
  ArrMath.NumberToStr(AParamArr[0],ArrayVarStr);
  ArrMath.NumberToStr(AParamArr[1],ResultStr);
...
begin
  ...
  ArrMath.NumberToStr(AParamArr[0],StrVarStr);
  ArrMath.NumberToStr(AParamArr[1],ResultStr);
  ...
  ATCCodeProperties^.Property_CodeVariable^.Vars_AtLast^.Var_GetValueStr(StrVarAIndex,StrA);
  ResultV:=Length(StrA);
...
begin
  ...
  ArrMath.NumberToStr(AParamArr[0],JumpToStr);
  ...
  ATCCodeProperties^.Property_CodePorts^.Vars^[ATCCodeProperties^.Property_CodePoint^.Point_StartMem_GetPoint].Var_GetValueInt(JumpToAIndex,JumpToV);
...
begin
  ...
  ArrMath.NumberToInt(AParamArr[0],JumpToInt);
  JumpToInt:=JumpToInt-1;
...
begin
  ...
  ArrMath.NumberToStr(AParamArr[0],GotoStr);
  ...
  ATCCodeProperties^.Property_CodePorts^.Vars^[ATCCodeProperties^.Property_CodePoint^.Point_StartMem_GetPoint].Var_GetValueInt(GotoAIndex,GotoV);
...
begin
  ...
  ArrMath.NumberToInt(AParamArr[0],GotoInt);
  GotoInt:=GotoInt-1;
...
begin
  ...
  VarName1Str:='$GV1';
  ArrMath.NumberToStr(AParamArr[0],VarName2Str);
...
begin
  ...
  VarNameStr:='$GV1';
  ArrMath.NumberToInt(AParamArr[0],AValue);
...
begin
  ...
  VarNameStr:='$GV1';
  ArrMath.NumberToReal(AParamArr[0],AValue);
...
begin
  ...
  VarNameStr:='$GV1';
  ArrMath.NumberToStr(AParamArr[0],AValue);
...
begin
  ...
  ATCCodeProperties^.Property_CodeVariable^.Vars_AtLast^.Var_GetValue(VarName1AIndex,Anum1);
  ATCCodeProperties^.Property_CodeVariable^.Vars_AtLast^.Var_GetValue(VarName2AIndex,Anum2);
...
begin
  ...
  ArrMath.NumberToStr(AParamArr[0],VarName1Str);
  ArrMath.NumberToStr(AParamArr[1],ResultVarStr);
...
begin
  ...
  ATCCodeProperties^.Property_CodeVariable^.Vars_AtLast^.Var_GetValueInt(VarName1AIndex,Anum1);
  ATCCodeProperties^.Property_CodeVariable^.Vars_AtLast^.Var_GetValueInt(VarName2AIndex,Anum2);
...
procedure CodeLine.V1GTV2_Real_Proc(AParamArr: TParamArr;
  var ATCCodeProperties: PtrCodeProperties);
var
  VarName1Str,VarName2Str,ResultVarStr:String;
  VarName1AIndex,VarName2AIndex,ResultVarAIndex:Integer;
...
begin
  ...
  ATCCodeProperties^.Property_CodeVariable^.Vars_AtLast^.Var_GetValueReal(VarName1AIndex,AReal1);
  ATCCodeProperties^.Property_CodeVariable^.Vars_AtLast^.Var_GetValueReal(VarName2AIndex,AReal2);
  self.GetGreaterThan_Real(AReal1,AReal2,Anum3);
  ATCCodeProperties^.Property_CodeVariable^.Vars_AtLast^.Var_SetValue(ResultVarAIndex,Anum3);

  SetLength(Anum3,0);
end;

procedure CodeLine.V1GTV2_Int_Proc(AParamArr: TParamArr;
  var ATCCodeProperties: PtrCodeProperties);
var
  VarName1Str,VarName2Str,ResultVarStr:String;
  VarName1AIndex,VarName2AIndex,ResultVarAIndex:Integer;
  Anum3:Number;
  AReal1,AReal2:Integer;
begin
  Anum3:=nil;
  AReal1:=0;
  AReal2:=0;
  ...
  ATCCodeProperties^.Property_CodeVariable^.Vars_AtLast^.Var_GetValueInt(VarName1AIndex,AReal1);
  ATCCodeProperties^.Property_CodeVariable^.Vars_AtLast^.Var_GetValueInt(VarName2AIndex,AReal2);
  self.GetGreaterThan_Int(AReal1,AReal2,Anum3);
  ATCCodeProperties^.Property_CodeVariable^.Vars_AtLast^.Var_SetValue(ResultVarAIndex,Anum3);

  SetLength(Anum3,0);
end;

procedure CodeLine.V1GTEqV2_Real_Proc(AParamArr: TParamArr;
  var ATCCodeProperties: PtrCodeProperties);
var
  VarName1Str,VarName2Str,ResultVarStr:String;
  VarName1AIndex,VarName2AIndex,ResultVarAIndex:Integer;
...
begin
  ...
  ATCCodeProperties^.Property_CodeVariable^.Vars_AtLast^.Var_GetValueReal(VarName1AIndex,AReal1);
  ATCCodeProperties^.Property_CodeVariable^.Vars_AtLast^.Var_GetValueReal(VarName2AIndex,AReal2);
  self.GetGreaterThanOrEqualTo_Real(AReal1,AReal2,Anum3);
  ATCCodeProperties^.Property_CodeVariable^.Vars_AtLast^.Var_SetValue(ResultVarAIndex,Anum3);

  SetLength(Anum3,0);
end;

procedure CodeLine.V1GTEqV2_Int_Proc(AParamArr: TParamArr;
  var ATCCodeProperties: PtrCodeProperties);
var
  VarName1Str,VarName2Str,ResultVarStr:String;
  VarName1AIndex,VarName2AIndex,ResultVarAIndex:Integer;
...
begin
  ...
  ATCCodeProperties^.Property_CodeVariable^.Vars_AtLast^.Var_GetValueInt(VarName1AIndex,AReal1);
  ATCCodeProperties^.Property_CodeVariable^.Vars_AtLast^.Var_GetValueInt(VarName2AIndex,AReal2);
  self.GetGreaterThanOrEqualTo_Int(AReal1,AReal2,Anum3);
  ATCCodeProperties^.Property_CodeVariable^.Vars_AtLast^.Var_SetValue(ResultVarAIndex,Anum3);

  SetLength(Anum3,0);
end;

procedure CodeLine.V1LTV2_Real_Proc(AParamArr: TParamArr;
  var ATCCodeProperties: PtrCodeProperties);
var
  VarName1Str,VarName2Str,ResultVarStr:String;
  VarName1AIndex,VarName2AIndex,ResultVarAIndex:Integer;
...
begin
  ...
  ATCCodeProperties^.Property_CodeVariable^.Vars_AtLast^.Var_GetValueReal(VarName1AIndex,AReal1);
  ATCCodeProperties^.Property_CodeVariable^.Vars_AtLast^.Var_GetValueReal(VarName2AIndex,AReal2);
  self.GetLessThan_Real(AReal1,AReal2,Anum3);
  ATCCodeProperties^.Property_CodeVariable^.Vars_AtLast^.Var_SetValue(ResultVarAIndex,Anum3);

  SetLength(Anum3,0);
end;

procedure CodeLine.V1LTV2_Int_Proc(AParamArr: TParamArr;
  var ATCCodeProperties: PtrCodeProperties);
var
  VarName1Str,VarName2Str,ResultVarStr:String;
  VarName1AIndex,VarName2AIndex,ResultVarAIndex:Integer;
...
begin
  ...
  ATCCodeProperties^.Property_CodeVariable^.Vars_AtLast^.Var_GetValueInt(VarName1AIndex,AReal1);
  ATCCodeProperties^.Property_CodeVariable^.Vars_AtLast^.Var_GetValueInt(VarName2AIndex,AReal2);
  self.GetLessThan_Int(AReal1,AReal2,Anum3);
  ATCCodeProperties^.Property_CodeVariable^.Vars_AtLast^.Var_SetValue(ResultVarAIndex,Anum3);

  SetLength(Anum3,0);
end;

procedure CodeLine.V1LTEqV2_Real_Proc(AParamArr: TParamArr;
  var ATCCodeProperties: PtrCodeProperties);
var
  VarName1Str,VarName2Str,ResultVarStr:String;
  VarName1AIndex,VarName2AIndex,ResultVarAIndex:Integer;
...
begin
  ...
  ATCCodeProperties^.Property_CodeVariable^.Vars_AtLast^.Var_GetValueReal(VarName1AIndex,AReal1);
  ATCCodeProperties^.Property_CodeVariable^.Vars_AtLast^.Var_GetValueReal(VarName2AIndex,AReal2);
  self.GetLessThanOrEqualTo_Real(AReal1,AReal2,Anum3);
  ATCCodeProperties^.Property_CodeVariable^.Vars_AtLast^.Var_SetValue(ResultVarAIndex,Anum3);

  SetLength(Anum3,0);
end;

procedure CodeLine.V1LTEqV2_Int_Proc(AParamArr: TParamArr;
  var ATCCodeProperties: PtrCodeProperties);
var
  VarName1Str,VarName2Str,ResultVarStr:String;
  VarName1AIndex,VarName2AIndex,ResultVarAIndex:Integer;
...
begin
  ...
  ATCCodeProperties^.Property_CodeVariable^.Vars_AtLast^.Var_GetValueInt(VarName1AIndex,AReal1);
  ATCCodeProperties^.Property_CodeVariable^.Vars_AtLast^.Var_GetValueInt(VarName2AIndex,AReal2);
  self.GetLessThanOrEqualTo_Int(AReal1,AReal2,Anum3);
  ATCCodeProperties^.Property_CodeVariable^.Vars_AtLast^.Var_SetValue(ResultVarAIndex,Anum3);
...
begin
  ...
  ArrMath.NumberToStr(AParamArr[0],VarName1Str);
  ArrMath.NumberToStr(AParamArr[1],JumpToTrueStr);
  ArrMath.NumberToStr(AParamArr[2],JumpToFalseStr);
  ...
  ATCCodeProperties^.Property_CodeVariable^.Vars_AtLast^.Var_GetValue(VarName1AIndex,Anum1);
  ATCCodeProperties^.Property_CodePorts^.Vars^[ATCCodeProperties^.Property_CodePoint^.Point_StartMem_GetPoint].Var_GetValueInt(JumpToTrueAIndex,JumpToTrueNum);
  ATCCodeProperties^.Property_CodePorts^.Vars^[ATCCodeProperties^.Property_CodePoint^.Point_StartMem_GetPoint].Var_GetValueInt(JumpToFalseAIndex,JumpToFalseNum);
...
begin
  ...
  ArrMath.NumberToStr(AParamArr[0],VarName1Str);
  ArrMath.NumberToStr(AParamArr[1],JumpToFalseStr);
...
begin
  ...
  ArrMath.NumberToStr(AParamArr[0],VarName1Str);
  ArrMath.NumberToStr(AParamArr[1],GotoTrueStr);
  ArrMath.NumberToStr(AParamArr[2],GotoFalseStr);
  ...
  ATCCodeProperties^.Property_CodeVariable^.Vars_AtLast^.Var_GetValue(VarName1AIndex,Anum1);
  ATCCodeProperties^.Property_CodePorts^.Vars^[ATCCodeProperties^.Property_CodePoint^.Point_StartMem_GetPoint].Var_GetValueInt(GotoTrueAIndex,GotoTrueNum);
  ATCCodeProperties^.Property_CodePorts^.Vars^[ATCCodeProperties^.Property_CodePoint^.Point_StartMem_GetPoint].Var_GetValueInt(GotoFalseAIndex,GotoFalseNum);
...
begin
  ...
  ArrMath.NumberToStr(AParamArr[0],VarName1Str);
  ArrMath.NumberToStr(AParamArr[1],GotoFalseStr);
...
begin
  ...
  ArrMath.NumberToStr(AParamArr[0],VarNameStr);
  ArrMath.NumberToStr(AParamArr[1],CountVarStr);
  ArrMath.NumberToStr(AParamArr[2],ResultStrStr);
  ...
  ATCCodeProperties^.Property_CodeVariable^.Vars_AtLast^.Var_GetValue(VarNameAIndex,Anum1);
  ATCCodeProperties^.Property_CodeVariable^.Vars_AtLast^.Var_GetValue(CountVarAIndex,Anum2);
...
begin
  Anum1:=0;
  ArrMath.NumberToInt(AParamArr[0],Anum1);

  ATCCodeProperties^.Property_CodePoint^.Point_StartMem_AddLast(Anum1);
...
begin
  ...
  ArrMath.NumberToStr(AParamArr[1],ResultIntVarNameStr);
...
begin
  ...
  ArrMath.NumberToStr(AParamArr[0],VarNameStrStr);
  ArrMath.NumberToStr(AParamArr[1],VarNameIntPos1Str);
  ArrMath.NumberToStr(AParamArr[2],VarNameIntPos2Str);
  ArrMath.NumberToStr(AParamArr[3],VarNameResultStrStr);
  ...
  ATCCodeProperties^.Property_CodeVariable^.Vars_AtLast^.Var_GetValueStr(VarNameStrAIndex,AStr1);
  ATCCodeProperties^.Property_CodeVariable^.Vars_AtLast^.Var_GetValueInt(VarNameIntPos1AIndex,AInt1);
  ATCCodeProperties^.Property_CodeVariable^.Vars_AtLast^.Var_GetValueInt(VarNameIntPos2AIndex,AInt2);
...
begin
  ...
  ArrMath.NumberToStr(AParamArr[1],VarNameResultStrStr);
...
procedure CodeLine.ExitCores_Proc(AParamArr: TParamArr;
  var ATCCodeProperties: PtrCodeProperties);
begin
  ATCCodeProperties^.TCExitCores:=1;
end;

procedure CodeLine.RestartCoreAt_Proc(AParamArr: TParamArr;
  var ATCCodeProperties: PtrCodeProperties);
var
  VarNameIntStr:String;
  VarNameIntAIndex:Integer;
begin
  VarNameIntStr:='';
  ...
  ATCCodeProperties^.Property_CodeVariable^.Vars_AtLast^.Var_GetValueInt(VarNameIntAIndex,ATCCodeProperties^.TCRestartCore_AtCore);
  ATCCodeProperties^.TCRestartCore_Signal:=1;
end;
...
begin
  SetLength(self.TParaArr,Length(self.TParaArr)+1);
  ArrMath.IntToNumber(ParamData,self.TParaArr[Length(self.TParaArr)-1]);
end;

procedure CodeLine.Code_AddParamDataReal(const ParamData: Real);
begin
  SetLength(self.TParaArr,Length(self.TParaArr)+1);
  ArrMath.RealToNumber(ParamData,self.TParaArr[Length(self.TParaArr)-1]);
end;

procedure CodeLine.Code_AddParamDataStr(const ParamData: String);
begin
  SetLength(self.TParaArr,Length(self.TParaArr)+1);
  ArrMath.StrToNumber(ParamData,self.TParaArr[Length(self.TParaArr)-1]);
end;
...
procedure CodeLine.Code_GetParamData(const AIndexBaseZero: Integer;
  var ValueResult: Number);
begin
  SetLength(ValueResult,0);
...
begin
  ValueResult:=0;
  if(AIndexBaseZero<0)or(AIndexBaseZero>(Length(self.TParaArr)-1))then Exit;
  ArrMath.NumberToInt(self.TParaArr[AIndexBaseZero],ValueResult);
end;

procedure CodeLine.Code_GetParamDataReal(const AIndexBaseZero: Integer;
  var ValueResult: Real);
begin
  ValueResult:=0.0;
  if(AIndexBaseZero<0)or(AIndexBaseZero>(Length(self.TParaArr)-1))then Exit;
  ArrMath.NumberToReal(self.TParaArr[AIndexBaseZero],ValueResult);
end;

procedure CodeLine.Code_GetParamDataStr(const AIndexBaseZero: Integer;
  var ValueResult: String);
begin
  ValueResult:='';
  if(AIndexBaseZero<0)or(AIndexBaseZero>(Length(self.TParaArr)-1))then Exit;
  ArrMath.NumberToStr(self.TParaArr[AIndexBaseZero],ValueResult);
end;

function CodeLine.Code_RunFuncData(var APtrCodeProperties: PtrCodeProperties
  ): Boolean;
begin
  Result:=False;
  if(self.TFuncDataIsNor=0)then begin
    self.TFuncDataObj(self.TParaArr,APtrCodeProperties);
    Result:=True;
  end else
  if(self.TFuncDataIsNor=1)then begin
    self.TFuncDataNor(self.TParaArr,APtrCodeProperties);
    Result:=True;
  end;
end;
...
begin
  ...
  for i:=0 to (Length(ValueResult)-1)do ValueResult[i]:=num[i];
end;
...
begin
  ValueResult:=0;
  SetLength(num,SizeOf(ValueResult));
  Move(num[0],ValueResult,SizeOf(ValueResult));
end;
...
begin
  ...
  TCBuild.Build_Basic^.Component_Length('NumResult','numLength1');
  TCBuild.Build_Basic^.Component_V1GTV2_Int('numLength1','NumOne','bool1');
  TCBuild.Build_Basic^.Component_IfV1False('bool1','JumpFalse2');
...
begin
  ...
  TCBuild.Build_Basic^.Component_AllocateMem('nilValue',nil);
  TCBuild.Build_Basic^.Component_AllocateMem('TArr1',nil);
  TCBuild.Build_Basic^.Component_AllocateMem('TArr2',nil);
  TCBuild.Build_Basic^.Component_AllocateMem('nCount1',0);
  ...
  TCBuild.Build_Basic^.Component_V1EqV2('numLength1','NumOne','bool1');
  TCBuild.Build_Basic^.Component_IfV1False('bool1','JumpFalse3');

  TCBuild.Build_Basic^.Component_SumInteger('nCount1','NumOne','nCount1');

  TCBuild.Build_Basic^.Component_Port('JumpFalse3');
  ...
  TCBuild.Build_Basic^.Component_V1EqV2('nCount1','THindexMax','bool1');
  TCBuild.Build_Basic^.Component_IfV1False('bool1','JumpFalse4');

  TCBuild.Build_Basic^.Component_ExitCores;

  TCBuild.Build_Basic^.Component_Port('JumpFalse4');
  ...
  TCBuild.Build_Basic^.Component_MulInteger('THindexMax','NumThree','CalcuA');
  TCBuild.Build_Basic^.Component_SumInteger('CalcuA','i','CalcuA');
  TCBuild.Build_Basic^.Component_MoveV2ToPortC('CalcuA','nilValue');
  ...
  TCBuild.Build_Basic^.Component_RestartCoreAt('i');
  ...
  TCBuild.Build_Basic^.Component_RestartCoreAt('THindexMax');
...
begin
  for i:=0 to (NumLength-1)do begin
    ...
    TCCores.Cores_SetProperty_AppendVariable(CAIndex,'Num1',[num1[i]]);
    TCCores.Cores_SetProperty_AppendVariable(CAIndex,'Num2',[num2[i]]);
  end;
...
begin
  n1:=nil;
  for i:=0 to (NumLength-1)do begin
    TCCores.Cores_GetPropertyVar_Number(i,'NumResult',n1);
    SetLength(numResult,Length(numResult)+1);
    numResult[Length(numResult)-1]:=n1[0];
  end;
  SetLength(n1,0);
end;
begin
  ...
  Result:=TCCores.Cores_RunPropertyUntilOutBound;
...
begin
  ...
  While(True)do begin
    ...
    for i:=0 to (TCCores.Cores_ArrLength-1)do begin
      ...
      TCCores.Cores_GetPropertyVar_Number(i,'NumResult',TArr1[Length(TArr1)-1]);
    ...
    nCount1:=0;
    for i:=0 to (TCCores.Cores_ArrLength-1)do begin
      TCCores.Cores_GetPropertyVar_Number(i,'NumResult',n3);
