...
type
  ...
  public
    ...
    function Component_isPositiveIntAdvance(const numIntArr,ByteResult:String):Integer;
...
function CodeComponent.Component_isPositiveIntAdvance(const numIntArr,
  ByteResult: String): Integer;
var
  AMem1:String;
begin
